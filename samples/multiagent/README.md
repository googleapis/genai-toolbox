...
> [!NOTE]
> This demo is NOT actively maintained by the MCP Toolbox for Databases team.
...
* **Flight Agent:** This is a specialized agent that helps queries flight databases, compares prices, and handles flight booking details.
* **Hotel Agent:** This is a specialized agent that helps searches for hotel accommodations, compares prices, and manages hotel reservations.

![multiagent architecture](./architecture.png)

	...
	}{
		{
			...
			wantToolset: server.ToolsetConfigs{
				"alloydb-postgres-admin-tools": tools.ToolsetConfig{
					...
					ToolNames: []string{"alloydb-create-cluster", "alloydb-operations-get", "create_instance", "list_clusters", "list_instances", "list_users", "alloydb-create-user", "get_cluster"},
				},
			},
		},
		{

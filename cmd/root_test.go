...
func TestPrebuiltTools(t *testing.T) {
	...
	t.Setenv("LOOKERCA_BASE_URL", "https://your_company.looker.com")
	t.Setenv("LOOKERCA_CLIENT_ID", "your_looker_client_id")
	t.Setenv("LOOKERCA_CLIENT_SECRET", "your_looker_client_secret")
	t.Setenv("LOOKERCA_VERIFY_SSL", "true")
	t.Setenv("LOOKERCA_PROJECT", "your_project_id")
	t.Setenv("LOOKERCA_LOCATION", "us")
	...
	tcs := []struct {
		...
		},
		{
			...
			wantToolset: server.ToolsetConfigs{
				"looker_tools": tools.ToolsetConfig{
					Name:      "lookerca_tools",
					ToolNames: []string{"ask_data_insights"},
				},
			},
		},
		{

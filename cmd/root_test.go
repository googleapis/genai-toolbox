	...
	}{
		{
			...
			wantToolset: server.ToolsetConfigs{
				"alloydb-postgres-admin-tools": tools.ToolsetConfig{
					...
					ToolNames: []string{"alloydb-create-cluster", "alloydb-operations-get", "alloydb-create-instance", "alloydb-list-clusters", "list_instances", "alloydb-list-users", "alloydb-create-user"},
				},
			},
		},
		{

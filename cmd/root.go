...
import (
	...
	_ "github.com/googleapis/genai-toolbox/internal/tools/clickhousedescribetable"
	_ "github.com/googleapis/genai-toolbox/internal/tools/clickhouseexecutesql"
	_ "github.com/googleapis/genai-toolbox/internal/tools/clickhouselisttables"
	_ "github.com/googleapis/genai-toolbox/internal/tools/clickhousesql"
...
func NewCommand(opts ...Option) *Command {
	...
	flags.StringVar(&cmd.prebuiltConfig, "prebuilt", "", "Use a prebuilt tool configuration by source type. Cannot be used with --tools-file. Allowed: 'alloydb-postgres', 'bigquery', 'clickhouse', 'cloud-sql-mysql', 'cloud-sql-postgres', 'cloud-sql-mssql', 'postgres', 'spanner', 'spanner-postgres'.")

		...
		},
		{
			...
			wantToolset: server.ToolsetConfigs{
				"discovery": tools.ToolsetConfig{
					Name:      "discovery",
					ToolNames: []string{"search_entries", "lookup_entry", "search_aspect_types", "lookup_context", "search_dq_scans", "list_data_products", "get_data_product", "list_data_assets", "get_data_asset", "create_data_product", "update_data_product"},
				},
			},
		},
		{

...
**Filtering Toolsets:**
You can load a specific toolset from a prebuilt configuration by prepending a `/` and the toolset name, for example: `--prebuilt=postgres/data` to only load the SQL tools.

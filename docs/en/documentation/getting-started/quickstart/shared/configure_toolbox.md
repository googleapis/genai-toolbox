...
1.  Download the latest version of Toolbox as a binary:
    ...
    curl -O https://storage.googleapis.com/mcp-toolbox-for-databases/v1.7.0/$OS/toolbox
    ```
...
1.  [Optional] Verify the downloaded binary's authenticity and integrity:
    ...
    <!-- {x-release-please-start-version} -->
    curl -O https://storage.googleapis.com/mcp-toolbox-for-databases/v1.7.0/$OS/toolbox.asc
    <!-- {x-release-please-end} -->

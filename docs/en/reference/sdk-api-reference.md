...
weight: 2
description: >
  Auto-generated API reference sites for the MCP Toolbox client SDKs.
---

Each MCP Toolbox client SDK publishes an auto-generated API reference site
documenting its public classes, functions, and types. Use these when you need the
exact signatures and symbol-level details for a package.

For usage guides, quickstarts, and framework-specific examples, see
[Toolbox SDKs](../documentation/connect-to/toolbox-sdks/_index.md).

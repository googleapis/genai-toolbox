...
weight: 2
description: >
  How to get started running Toolbox with MCP Inspector and Dapr Agents.
---
...
Ensure your OpenAI API key is exported in the environment:
```sh
...
And now you can run the agent with:
```sh

...
linkTitle: "Serverless for Apache Spark"
type: docs
weight: 1
description: >
  The Serverless for Apache Spark source enables the Toolbox to interact with Google Cloud Serverless for Apache Spark.
---

# Google Cloud Serverless for Apache Spark Source

The [Google Cloud Serverless for Apache Spark](https://cloud.google.com/dataproc-serverless/docs/overview) source allows
...
Google Cloud Serverless for Apache Spark uses [Identity and Access Management

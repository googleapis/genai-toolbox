...
- [`bigquery-conversational-analytics-list-data-agent`](../tools/bigquery/bigquery-conversational-analytics-list-data-agent.md)
  List all available Conversational Analytics data agents for a given project.
...
| allowedDatasets | []string |    false     | An optional list of dataset IDs that tools using this source are allowed to access. If provided, any tool operation attempting to access a dataset not in this list will be rejected. If a single dataset is provided, it will be treated as the default for prebuilt tools. <br><br> **Affected Tools:** <br> This restriction applies to the following tools by analyzing the tables they access. To enforce this, certain unsafe operations (like `EXECUTE IMMEDIATE` or dataset-level DDL) are disallowed in these tools when `allowedDatasets` is active. <ul><li>`bigquery-conversational-analytics`</li><li>`bigquery-execute-sql`</li><li>`bigquery-forecast`</li><li>`bigquery-list-table-ids`</li></ul> <br> **Unaffected Tools:** <br> The following tools are not subject to this restriction as they operate on project-level, do not access table data directly, or do not yet support this feature: <ul><li>`bigquery-analyze-contribution`</li><li>`bigquery-conversational-analytics-list-data-agent`</li><li>`bigquery-get-dataset-info`</li><li>`bigquery-get-table-info`</li><li>`bigquery-list-dataset-ids`</li><li>`bigquery-search-catalog`</li><li>`bigquery-sql`</li></ul> |

...
tokens](../authServices/_index.md#specifying-id-tokens-from-clients) that are passed in
...
the required [authServices](../authServices/_index.md) to specific claims within the
user's ID token.
...
| **field** | **type** | **required** | **description**                                                                         |
|-----------|:--------:|:------------:|-----------------------------------------------------------------------------------------|
| name      |  string  |     true     | Name of the [authServices](../authServices/_index.md) used to verify the OIDC auth token.         |
...
[authServices](../authServices/_index.md) defined in the previous section.

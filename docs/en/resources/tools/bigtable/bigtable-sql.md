...
{{<notice note>}}
  **Please note that Bigtable's GoogleSQL support for DML statements might be limited to certain query types.**. For detailed information on supported DML statements and use cases, refer to the [Google Cloud Bigtable GoogleSQL overview](https://cloud.google.com/bigtable/docs/googlesql-overview#use-cases).
{{</notice>}}

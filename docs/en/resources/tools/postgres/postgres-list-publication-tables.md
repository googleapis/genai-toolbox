...
- `table_name` (optional): Filters by a comma-separated list of table names. Default: `""`
- `publication_name` (optional): Filters by a comma-separated list of publication names. Default: `""`
- `schema_name` (optional): Filters by a comma-separated list of schema names. Default: `""`

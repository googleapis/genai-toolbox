---
title: "firestore-get-schema"
type: docs
weight: 1
description: >
  A "firestore-get-schema" tool introspects Firestore collections to infer field types and schema definitions.
---
...
|-------------|:--------:|:------------:|-----------------|
| type | string | true | Must be "firestore-get-schema". |

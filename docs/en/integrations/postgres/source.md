...
| connectTimeout | string | false | Maximum time to wait for a single connection attempt, as a positive Go duration (e.g. "5s"). When omitted, no timeout is applied and connection behavior is unchanged. |

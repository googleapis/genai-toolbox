...
func TestBigQueryToolEndpoints(t *testing.T) {
	...
	createCol := `["id INT64", "name STRING", "age INT64"]`
	tests.RunToolInvokeWithTemplateParameters(t, tableNameTemplateParam, tmplSelectAllWant, tmplSelect1Want, "", "", createCol, false, false)

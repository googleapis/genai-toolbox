...
func GetToolsConfig(sourceConfig map[string]any, toolKind, paramToolStatement, arrayToolStatement, authToolStatement string) map[string]any {
	...
	toolsFile := map[string]any{
		...
		"tools": map[string]any{
			...
			"my-array-tool": map[string]any{
				...
				"statement":   paramToolStatement2arrayToolStatement,
				"parameters": []any{
					map[string]any{
						"name":        "idArray",
						"type":        "array",
	...
	toolsFile := map[string]any{
		...
		"tools": map[string]any{
			...
			"my-array-tool": map[string]any{
				...
				"source":      "my-instance",
				"description": "Tool to test invocation with array params.",
				"commands":    [][]string{{"HGET", "row1", "{{.fields}}"}, {"HGETALL", "row3"}},
				"parameters": []any{
					map[string]any{
						"name":        "fieldsArray",
						"type":        "array",

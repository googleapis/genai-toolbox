...
func TestCouchbaseToolEndpoints(t *testing.T) {
	...
	tmplSelectCombined, tmplSelectFilterCombined, params3 := getCouchbaseTemplateParamToolInfo()
	...
	toolsFile = tests.AddTemplateParamConfig(t, toolsFile, couchbaseToolKind, tmplSelectCombined, tmplSelectFilterCombined)
...
func getCouchbaseTemplateParamToolInfo() (string, string, []map[string]any) {
	...
	return tmplSelectCombined, tmplSelectFilterCombined, params
}

        ...
        <div class="auth-method-details" id="google-auth-details-${UNIQUE_ID_BASE}" style="display: none;">
            <div class="auth-controls">
                ...
                <div class="auth-instructions">
                    <strong>Important:</strong> To avoid "Error 401: invalid_client", ensure your current Toolbox UI URL (ex: <code>http://localhost:PORT</code>) is added to the "Authorized JavaScript origins" list for this OAuth Client ID in the

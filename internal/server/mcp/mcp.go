...
func ProcessMethod(ctx context.Context, mcpVersion string, id jsonrpc.RequestId, method string, g group.Group, resourceMgr *resources.ResourceManager, body []byte, header http.Header) (any, error) {
	...
	case mcputil.VERSION_DRAFT:
		if enableDraft {
			return vdraft.ProcessMethod(ctx, id, method, g, resourceMgr, body, header)
		}
		return jsonrpc.NewUnsupportedProtocolVersionError(id, mcpVersion, enableDraft)
	case mcputil.VERSION_20251125:
		return v20251125.ProcessMethod(ctx, id, method, g, resourceMgr, body, header)
	case mcputil.VERSION_20250618:
		return v20250618.ProcessMethod(ctx, id, method, g, resourceMgr, body, header)
	case mcputil.VERSION_20250326:
		return v20250326.ProcessMethod(ctx, id, method, g, resourceMgr, body, header)
	case "", mcputil.VERSION_20241105:
		return v20241105.ProcessMethod(ctx, id, method, g, resourceMgr, body, header)
	default:
		return jsonrpc.NewUnsupportedProtocolVersionError(id, mcpVersion, enableDraft)
	}
}

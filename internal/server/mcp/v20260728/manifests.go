...
func GenerateListToolsResult(pMgr *primitives.PrimitiveManager, g group.Group, urlParams map[string]string, supportedExts map[string]any) (ListToolsResult, error) {
...
// tools and prompts.
func GenerateGetGroupResult(pMgr *primitives.PrimitiveManager, g group.Group, urlParams map[string]string, supportedExts map[string]any) (GetGroupResult, error) {
	listToolsResult, err := GenerateListToolsResult(pMgr, g, urlParams, supportedExts)
	if err != nil {

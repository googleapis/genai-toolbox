...
func TestGetEntityTypeForSet(t *testing.T) {
	xmlData := []byte(`
<edmx:Edmx Version="1.0" xmlns:edmx="http://schemas.microsoft.com/ado/2007/06/edmx" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata">
    <edmx:DataServices m:DataServiceVersion="2.0">
        <Schema Namespace="SAMPLE_SRV" xmlns="http://schemas.microsoft.com/ado/2008/09/edm">
            <EntityType Name="CustomerType">
                <Property Name="CustomerID" Type="Edm.String" Nullable="false" />
            </EntityType>
            <EntityContainer Name="SAMPLE_SRV_Entities">
                <EntitySet Name="Customers" EntityType="SAMPLE_SRV.CustomerType" />
            </EntityContainer>
        </Schema>
    </edmx:DataServices>
</edmx:Edmx>`)
	...
	// Positive test
	et, err := meta.GetEntityTypeForSet("Customers")
	if err != nil {
		t.Fatalf("GetEntityTypeForSet failed for valid set: %v", err)
	}
	if et.Name != "CustomerType" {
		t.Errorf("Expected CustomerType, got %s", et.Name)
	}

	// Negative test - non-existent entity set
	_, err = meta.GetEntityTypeForSet("NonExistentSet")
	if err == nil {
		t.Errorf("Expected error for non-existent entity set, got nil")
	}
}

...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	allParameters := tools.Parameters{
		projectParam,
		tools.NewStringParameter("sourceInstanceName", "The name of the instance to be cloned."),
		tools.NewStringParameter("destinationInstanceName", "The name of the new instance that will be created by cloning the source instance."),
		// point in time, preferred zone and preferred secondary zone are optional
		tools.NewStringParameterWithRequired("pointInTime", "The timestamp in RFC 3339 format to which the source instance should be cloned.", false),
		tools.NewStringParameterWithRequired("preferredZone", "The preferred zone for the new instance.", false),
		tools.NewStringParameterWithRequired("preferredSecondaryZone", "The preferred secondary zone for the new instance.", false),
	}

...
package dataplexgetdataquality
...
const resourceType string = "dataplex-get-data-quality"
...
type compatibleSource interface {
	ProjectID() string
	GetDataQuality(ctx context.Context, projectID, location, scanID string) (*dataplexpb.DataScan, error)
}
...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	scanId := parameters.NewStringParameter("scanId", "Required. The unique ID of the Dataplex DataScan (e.g. 'nq-dq-12345...'). This is extracted from the target or name field of the creation operation.")
...
func (t Tool) Invoke(ctx context.Context, resourceMgr tools.SourceProvider, params parameters.ParamValues, accessToken tools.AccessToken) (any, util.ToolboxError) {
	...
	resp, err := source.GetDataQuality(ctx, projectId, location, scanId)
	if err != nil {

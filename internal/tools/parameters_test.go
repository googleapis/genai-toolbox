	...
	tcs := []struct {
		...
		},
		{
			...
			want: tools.McpProperty{
				...
				Type:        "array",
				Description: "bar",
				Items:       &tools.McpProperty{Name: "foo-string", Type: "string", Description: "bar"},
			},
		},
	}
	for _, tc := range tcs {

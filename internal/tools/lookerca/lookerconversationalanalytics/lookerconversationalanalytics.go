...
import (
	...
	lookercads "github.com/googleapis/genai-toolbox/internal/sources/lookerca"
...
const kind string = "lookerca-conversational-analytics"
...
var _ compatibleSource = &lookercads.Source{}

var compatibleSources = [...]string{lookercads.SourceKind}

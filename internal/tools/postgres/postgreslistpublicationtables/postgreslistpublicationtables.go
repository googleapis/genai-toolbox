...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	allParameters := parameters.Parameters{
		parameters.NewStringParameterWithDefault("table_name", "", "Optional: Filters by a comma-separated list of table names."),
		parameters.NewStringParameterWithDefault("publication_name", "", "Optional: Filters by a comma-separated list of publication names."),
		parameters.NewStringParameterWithDefault("schema_name", "", "Optional: Filters by a comma-separated list of schema names."),

...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	allParameters := tools.Parameters{
		tools.NewStringParameter("name", "The short name of the batch, e.g. for \"projects/my-project/locations/us-central1/batches/my-batch\", pass \"my-batch\" (the project and location are pre-configured in the tool)"),
	}

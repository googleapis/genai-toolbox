...
// Package cloudsqlmssqlconnectgce provides a tool that connects a Cloud SQL
// for SQL Server instance to a Google Compute Engine VM: it validates network
...
package cloudsqlmssqlconnectgce
...
const resourceType string = "cloud-sql-mssql-connect-gce"
...
// Config defines the configuration for the cloud-sql-mssql-connect-gce tool.
type Config struct {
...
func (cfg Config) Initialize(context.Context) (tools.Tool, error) {
	if cfg.Description == "" {
		cfg.Description = "Helps connect a Cloud SQL SQL Server instance to a GCE VM. " +
...
// Tool represents the cloud-sql-mssql-connect-gce tool.
type Tool struct {

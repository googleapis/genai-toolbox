...
package lookerupdateproject_test
...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookerupdateproject"
...
func TestInvokeValidation(t *testing.T) {
	...
	tcs := []struct {
		...
		{
			desc:    "missing project_id",
			params:  parameters.ParamValues{},
			wantErr: "project_id must be specified",
		},
	}
...
func TestManifest(t *testing.T) {
	...
	expectedParams := []string{"project_id", "git_remote_url", "git_service_name", "git_production_branch_name", "pull_request_mode", "validation_required", "git_release_mgmt_enabled", "allow_warnings"}

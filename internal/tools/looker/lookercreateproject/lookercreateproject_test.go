...
package lookercreateproject_test
...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookercreateproject"
...
func TestInvokeValidation(t *testing.T) {
	...
	tcs := []struct {
	...
	}{
		{
			desc: "missing name",
			params: parameters.ParamValues{
				{Name: "git_production_branch_name", Value: "main"},
			},

...
package lookercreategitdeploykey_test
...
import (
	...
	lkr "github.com/googleapis/mcp-toolbox/internal/tools/looker/lookercreategitdeploykey"
...
func TestManifest(t *testing.T) {
	...
	expectedParams := []string{"project_id"}

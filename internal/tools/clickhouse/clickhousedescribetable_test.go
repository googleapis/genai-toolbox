...
func TestConfigInitializeValidSource(t *testing.T) {
	...
	if len(clickhouseTool.Parameters) != 2 {
		t.Errorf("Expected 2 parameters, got %d", len(clickhouseTool.Parameters))
	}
	...
	expectedParamNames := []string{"table_name", "database_name"}
